      ...
      <div className="section-shell relative z-10 px-4 sm:px-6">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12 sm:mb-16">
          <div className="max-w-2xl space-y-3">
            <motion.div
              ...
              viewport={{ once: true }}
              className="inline-flex items-center gap-2 rounded-full bg-orange-100/80 border border-orange-200 px-3.5 py-1 text-xs font-bold text-orange-900"
            >
        ...
        <div className="grid gap-5 sm:gap-6 lg:grid-cols-12">
          ...
          <motion.div
            ...
            className="lg:col-span-7 group relative rounded-[2rem] sm:rounded-[2.5rem] bg-gradient-to-br from-slate-900 via-[#0F172A] to-slate-950 p-1.5 sm:p-2 border border-slate-800 shadow-xl text-white flex flex-col justify-between hover:border-orange-500/50 hover:shadow-2xl transition-all"
          >
            <div className="rounded-[1.75rem] sm:rounded-[2rem] bg-gradient-to-br from-[#161F33] to-[#0D1322] p-5 sm:p-8 lg:p-9 space-y-5">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      <span className="rounded-full bg-orange-500 text-white px-2.5 py-0.5 text-[9px] sm:text-[10px] font-black uppercase tracking-wider shadow-sm">
                        Official Flagship
                      </span>
                    </div>
              ...
              <div className="pt-2 flex flex-col xs:flex-row gap-2.5">
                <Link
                  ...
                  className="btn-primary text-xs py-3 px-5 font-bold rounded-xl flex items-center justify-center gap-2 shadow-lg"
                >
          ...
          <motion.div
            ...
            whileHover={{ y: -4, transition: { duration: 0.2 } }}
            className="lg:col-span-5 group relative rounded-[2rem] sm:rounded-[2.5rem] bg-white p-1.5 sm:p-2 border border-slate-200 shadow-md flex flex-col justify-between hover:border-orange-400 hover:shadow-xl transition-all"
          >
            <div className="rounded-[1.75rem] sm:rounded-[2rem] bg-gradient-to-br from-slate-50 to-white p-5 sm:p-8 space-y-4">
              ...
              <div className="space-y-2 rounded-2xl bg-slate-100/80 p-3.5 text-xs text-slate-700">
                ...
                <div className="flex justify-between">
                  ...
                  <strong className="text-slate-900 truncate ml-2">Citygate Centre, Romford Rd</strong>
                </div>
                <div className="flex justify-between">
              ...
              <div className="pt-2 flex flex-col xs:flex-row gap-2.5">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="w-full rounded-xl border border-slate-300 bg-white py-3 px-4 text-center text-xs font-bold text-slate-800 hover:border-orange-500 transition-colors flex items-center justify-center gap-1.5"
                >
          ...
          <motion.div
            ...
            transition={{ delay: 0.1 }}
            whileHover={{ y: -4, transition: { duration: 0.2 } }}
            className="lg:col-span-4 rounded-[2rem] bg-white p-5 sm:p-7 border border-slate-200 shadow-sm hover:border-orange-400 hover:shadow-xl transition-all flex flex-col justify-between"
          >
